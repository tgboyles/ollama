...
- The Docker image includes all dependencies (Python, ollama-mcp-bridge, gemma3 model)
- Ollama server starts correctly
- The gemma3 model is available immediately (no download time)
